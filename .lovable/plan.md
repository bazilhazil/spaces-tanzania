...
- Add `property_manager` to the existing `app_role` enum (no new role table). Users can opt in from Settings → My Mode; accepting an invitation grants it automatically.

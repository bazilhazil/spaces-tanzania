      ...
      <main className="flex-1">
        <section className="border-b border-border/60 bg-secondary/40">
          <div className="container-page py-14">
            <p className="text-xs font-semibold uppercase tracking-widest text-gold">Featured people</p>
            <h1 className="mt-2 font-display text-4xl font-semibold text-foreground">
              Trusted agents across Tanzania
            </h1>
            <p className="mt-2 max-w-2xl text-muted-foreground">
              Every SPACES agent is vetted for professionalism, licensing, and response time.
            </p>
          </div>
        </section>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 inline-flex items-center gap-1 text-xs text-gold">
                      <Star className="h-3.5 w-3.5 fill-current" /> {a.rating.toFixed(1)} · {a.listings} listings
                    </p>
                  </div>
                </div>

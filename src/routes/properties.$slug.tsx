                ...
                {property.verified ? (
                  ...
                  <div className="mt-2 space-y-1.5">
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      {(verificationState === "in_progress" || verificationState === "more_info") && (
                    ...
                    <p className="text-xs text-muted-foreground">
                      {verificationState === "in_progress" || verificationState === "more_info"
                        ? "This property is currently being verified by SPACES. Please confirm property details and ownership before making any payment."
                        : "This property has not been verified by SPACES. Please confirm property details and ownership before making any payment."}
                    </p>
                  </div>
                )}

...
const SW: Record<string, string> = {
  ...
  // Phase 3A finance
  "Financial summary": "Muhtasari wa fedha", "Property value": "Thamani ya mali", "Agreed price": "Bei iliyokubaliwa",
  Deposit: "Amana", Balance: "Salio", "SPACES service fee": "Ada ya huduma ya SPACES", "SPACES Service Fee": "Ada ya Huduma ya SPACES",
  Tax: "Kodi ya serikali", "Dalali commission": "Kamisheni ya dalali", "Dalali Commission": "Kamisheni ya Dalali", "Other charges": "Gharama nyingine",
  "Other Charge": "Gharama nyingine", "Total payable": "Jumla ya kulipa", "Total paid": "Jumla iliyolipwa", "Balance remaining": "Salio lililobaki",
  "Fees and commission are locked when the offer is accepted and never change afterwards.": "Ada na kamisheni hufungwa ofa inapokubaliwa na hazibadiliki baadaye.",
  "Payment plan": "Mpango wa malipo", PENDING: "INASUBIRI", PROCESSING: "INASHUGHULIKIWA", PAID: "IMELIPWA", FAILED: "IMESHINDIKANA",
  CANCELLED: "IMESITISHWA", REFUNDED: "IMERUDISHWA", "PAID — TEST MODE": "IMELIPWA — MAJARIBIO", Receipt: "Stakabadhi",
  "TEST MODE — NOT A REAL PAYMENT": "MAJARIBIO — SI MALIPO HALISI", "TEST PAYMENT — NOT A REAL PAYMENT": "MALIPO YA MAJARIBIO — SI MALIPO HALISI",
  "PAY NOW": "LIPA SASA", "Online payment is not yet available. SPACES payment integration will be enabled soon.": "Malipo ya mtandaoni bado hayapatikani. Huduma ya malipo ya SPACES itawashwa hivi karibuni.",
  "Receipt number": "Namba ya stakabadhi", Date: "Tarehe", "Deal reference": "Namba ya mkataba", Property: "Mali", "Payment type": "Aina ya malipo",
  Amount: "Kiasi", "Payment method": "Njia ya malipo", Reference: "Kumbukumbu", "Test mode": "Majaribio", Print: "Chapisha",
  Revenue: "Mapato", "Estimated, pending and collected revenue are kept separate. Test payments are never counted as collected.": "Mapato yanayokadiriwa, yanayosubiri na yaliyokusanywa yametenganishwa. Malipo ya majaribio hayahesabiwi kamwe.",
  "Payment provider": "Mtoa huduma wa malipo", "NOT CONNECTED": "HAIJAUNGANISHWA", "Total transaction value": "Jumla ya thamani ya miamala",
  "Estimated SPACES revenue": "Mapato ya SPACES yanayokadiriwa", "Pending SPACES revenue": "Mapato ya SPACES yanayosubiri", "Collected SPACES revenue": "Mapato ya SPACES yaliyokusanywa",
  Taxes: "Kodi", "Dalali commissions": "Kamisheni za madalali", "Failed payments": "Malipo yaliyoshindikana", Refunds: "Marejesho",
  "Test payments (not revenue)": "Malipo ya majaribio (si mapato)", Payments: "Malipo",
  "All payment records. Payments are confirmed only by the payment provider or the separate admin test mode.": "Kumbukumbu zote za malipo. Malipo huthibitishwa na mtoa huduma wa malipo au hali ya majaribio ya admin pekee.",
  "Search reference, deal or buyer…": "Tafuta kumbukumbu, mkataba au mnunuzi…", "All payment types": "Aina zote za malipo", Subscription: "Usajili", Boost: "Kukuza tangazo",
  "No payments match these filters.": "Hakuna malipo yanayolingana na vichujio hivi.", TEST: "MAJARIBIO",
  "Refund requested": "Marejesho yameombwa", "Refund processing": "Marejesho yanashughulikiwa", "Refund refunded": "Imerudishwa", "Refund failed": "Marejesho yameshindikana",
  "Payment details": "Maelezo ya malipo", "Payment ID": "Namba ya malipo", Payer: "Mlipaji", Provider: "Mtoa huduma", "Provider transaction ID": "Namba ya muamala ya mtoa huduma",
  Created: "Imeundwa", Yes: "Ndiyo", No: "Hapana", "Failure reason": "Sababu ya kushindikana", "Refund status": "Hali ya marejesho",
  "Request refund": "Omba marejesho", "Mark refund processing": "Weka marejesho yanashughulikiwa", "Mark refunded": "Weka imerudishwa",
  "Refunds are recorded here only. No money is moved until a payment provider is connected.": "Marejesho yanarekodiwa hapa tu. Hakuna fedha zinazohamishwa hadi mtoa huduma wa malipo aunganishwe.",
  "Audit history": "Historia ya ukaguzi", "No audit entries.": "Hakuna kumbukumbu za ukaguzi.", "Reason (logged)": "Sababu (itarekodiwa)", Saved: "Imehifadhiwa",

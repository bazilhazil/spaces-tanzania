...
const SW: Record<string, string> = {
  ...
  "Receipt number": "Namba ya stakabadhi", Date: "Tarehe", "Deal reference": "Namba ya mkataba", "Payment type": "Aina ya malipo",
  Amount: "Kiasi", "Payment method": "Njia ya malipo", Reference: "Kumbukumbu", "Test mode": "Majaribio", Print: "Chapisha",
  "Estimated, pending and collected revenue are kept separate. Test payments are never counted as collected.": "Mapato yanayokadiriwa, yanayosubiri na yaliyokusanywa yametenganishwa. Malipo ya majaribio hayahesabiwi kamwe.",
